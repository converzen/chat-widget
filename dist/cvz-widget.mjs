...
`;if(O){O.debounceRendering;O.debounceRendering=t=>{requestAnimationFrame(t);};}var td="cvz-widget-host";function nd(e,t){let n=document.createElement("div");n.id=td,document.body.appendChild(n);let r=n.attachShadow({mode:"open"}),i=document.createElement("style");i.textContent=Gi,r.appendChild(i);let a=document.createElement("div");return a.id="cvz-root",r.appendChild(a),er(Ce(t,{config:e}),a),n}var Ki=class{hostElement=null;buildId="12c1cd5-2026-09-11T06:32:01.830Z";init(t){if(this.hostElement){console.warn("cvzWidget is already initialized.");return}console.log("init: Initializing cvzWidget...",this.buildId),console.log("CSS Length:",Gi.length),this.hostElement=nd(t,pu);}hide(){if(!this.hostElement){console.warn("hide: cvzWidget is not initialized.");return}this.hostElement&&(this.hostElement.remove(),this.hostElement=null);}},fu=new Ki;typeof window<"u"&&(window.cvzWidget=fu);var Wz=fu;export{Wz as default};