...
`);for(let r of n)if(r.startsWith("data: ")){let o=r.slice(6).trim();if(o)try{t.push(JSON.parse(o))}catch(l){console.error("Failed to parse SSE data:",o,l)}}return t}async function*Kc(e){let{baseUrl:t,message:n,persona:r,authToken:o,authType:l,maxTokens:i,abortSignal:u}=e,s={"Content-Type":"application/json",Accept:"text/event-stream"};l==="apiKey"?s["X-API-Key"]=o:s.Authorization=`Bearer ${o}`;let c={message:n};r&&(c.persona=r),i&&(c.max_tokens=i),console.log("sending completion request: ",JSON.stringify(c));let p=await fetch(`${t}/api/chat/completion/stream`,{method:"POST",headers:s,body:JSON.stringify(c),signal:u});if(!p.ok){let v=`HTTP ${p.status}: ${p.statusText}`;try{console.error(`error from completion: ${p.status} : ${p.statusText}`);let y=await p.json();v=y.message||y.detail||v}catch{}yield{type:"error",message:`${p.status} ${v}`};return}if(!p.body){yield{type:"error",message:"No response body received"};return}let m=p.body.getReader();yield*Qc(m)}async function*Yc(e){let{baseUrl:t,sessionId:n,message:r,authToken:o,authType:l,maxTokens:i,abortSignal:u}=e,s={"Content-Type":"application/json",Accept:"text/event-stream"};l==="apiKey"?s["X-API-Key"]=o:s.Authorization=`Bearer ${o}`;let c={session:n,message:r};i&&(c.max_tokens=i);let p=await fetch(`${t}/api/chat/continuation/stream`,{method:"POST",headers:s,body:JSON.stringify(c),signal:u});if(!p.ok){let v=`HTTP ${p.status}: ${p.statusText}`;try{let y=await p.json();v=y.message||y.detail||v}catch{}yield{type:"error",message:`${p.status} ${v}`};return}if(!p.body){yield{type:"error",message:"No response body received"};return}let m=p.body.getReader();yield*Qc(m)}var x=gn(lu()),Up="https://chat.converzent.de",Ap=e=>{if(!e?.position)return{bottom:"1rem",right:"1rem"};if(typeof e.position=="string")switch(e.position){case"bottom-right":return{bottom:"1rem",right:"1rem"};case"bottom-left":return{bottom:"1rem",left:"1rem"};case"top-right":return{top:"1rem",right:"1rem"};case"top-left":return{top:"1rem",left:"1rem"};default:return{bottom:"1rem",right:"1rem"}}else{let t={};return e.position.bottom&&(t.bottom=e.position.bottom),e.position.top&&(t.top=e.position.top),e.position.left&&(t.left=e.position.left),e.position.right&&(t.right=e.position.right),t}},$p=e=>{if(!e?.dialogSize)return{width:"350px",height:"500px"};if(typeof e.dialogSize=="string")switch(e.dialogSize){case"small":return{width:"300px",height:"400px"};case"medium":return{width:"350px",height:"500px"};case"large":return{width:"400px",height:"600px"};default:return{width:"350px",height:"500px"}}else return{width:`${Math.max(250,e.dialogSize.width)}px`,height:`${Math.max(300,e.dialogSize.height)}px`}},Vp=e=>e?.frameColor||"#E5E7EB",Wp=(e,t)=>{let n=e?.buttonColor;return t?{backgroundColor:n?.open||"#1F2937"}:{backgroundColor:n?.normal||"#2563EB","--hover-color":n?.hover||"#1D4ED8"}},Jc=()=>(0,x.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:1.5,stroke:"currentColor",className:"cvz-w-6 cvz-h-6",children:(0,x.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.337A5.972 5.972 0 015.41 20.97a5.969 5.969 0 01-.474-.065 4.48 4.48 0 00.978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.159 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z"})}),qc=()=>(0,x.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:1.5,stroke:"currentColor",className:"cvz-w-6 cvz-h-6",children:(0,x.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M6 18L18 6M6 6l12 12"})}),Hp=()=>(0,x.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:1.5,stroke:"currentColor",className:"cvz-w-5 cvz-h-5",children:(0,x.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5"})}),Bp=()=>(0,x.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:1.5,stroke:"currentColor",className:"cvz-w-5 cvz-h-5",children:(0,x.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0"})}),Qp=({title:e,subtitle:t,onClose:n,onClear:r})=>(0,x.jsxs)("div",{className:"cvz-bg-gradient-to-b cvz-from-blue-600 cvz-to-blue-500 cvz-text-white cvz-p-4 cvz-shadow-md cvz-flex cvz-justify-between cvz-items-start",children:[(0,x.jsxs)("div",{className:"cvz-flex cvz-items-center cvz-gap-3",children:[(0,x.jsxs)("div",{className:"cvz-relative",children:[(0,x.jsx)("div",{className:"cvz-w-2.5 cvz-h-2.5 cvz-bg-green-400 cvz-rounded-full cvz-border-2 cvz-border-blue-600"}),(0,x.jsx)("div",{className:"cvz-absolute cvz-top-0 cvz-left-0 cvz-w-2.5 cvz-h-2.5 cvz-bg-green-400 cvz-rounded-full cvz-animate-ping cvz-opacity-75"})]}),(0,x.jsxs)("div",{children:[(0,x.jsx)("h3",{className:"cvz-font-bold cvz-text-lg cvz-leading-tight",children:e}),t&&(0,x.jsx)("p",{className:"cvz-text-xs cvz-text-blue-100 cvz-mt-0.5",children:t})]})]}),(0,x.jsxs)("div",{className:"cvz-flex cvz-gap-2",children:[(0,x.jsx)("button",{onClick:r,className:"cvz-text-blue-200 cvz-hover:cvz-text-white cvz-transition-colors cvz-p-1 cvz-rounded-md cvz-hover:cvz-bg-blue-600/50",title:"Clear History",children:(0,x.jsx)(Bp,{})}),(0,x.jsx)("button",{onClick:n,className:"cvz-text-blue-200 cvz-hover:cvz-text-white cvz-transition-colors cvz-p-1 cvz-rounded-md cvz-hover:cvz-bg-blue-600/50",title:"Close Chat",children:(0,x.jsx)(qc,{})})]})]});var Kp=({messages:e,isStreaming:t,streamingMessage:n,messagesEndRef:r,enableMarkdown:o})=>{let l=(0,J.useRef)(null),[i,u]=(0,J.useState)(!0);return(0,J.useEffect)(()=>{let s=l.current;if(!s)return;let c=()=>{let{scrollTop:p,scrollHeight:m,clientHeight:v}=s,y=m-p-v<100;u(y)};return s.addEventListener("scroll",c),()=>s.removeEventListener("scroll",c)},[]),(0,J.useEffect)(()=>{i&&r.current&&r.current.scrollIntoView({behavior:"smooth"})},[e,n,i,r]),(0,x.jsxs)("div",{ref:l,className:"cvz-flex-1 cvz-overflow-y-auto cvz-p-4 cvz-bg-gray-50 cvz-space-y-4",children:[e.length===0&&!n&&(0,x.jsxs)("div",{className:"cvz-flex cvz-flex-col cvz-items-center cvz-justify-center cvz-h-full cvz-text-gray-400 cvz-space-y-2",children:[(0,x.jsx)(Jc,{}),(0,x.jsx)("p",{className:"cvz-text-sm",children:"Start a conversation"})]}),e.map(s=>(0,x.jsx)("div",{className:`cvz-flex ${s.role==="USER"?"cvz-justify-end":"cvz-justify-start"}`,children:(0,x.jsx)("div",{className:`cvz-max-w-[85%] cvz-p-3 cvz-rounded-2xl cvz-text-sm cvz-shadow-sm ${s.role==="USER"?"cvz-bg-blue-600 cvz-text-white cvz-rounded-br-none":"cvz-bg-white cvz-text-gray-800 cvz-border cvz-border-gray-100 cvz-rounded-bl-none"}`,children:s.content})},s.createdAt.toString())),t&&n&&(0,x.jsx)("div",{className:"cvz-flex cvz-justify-start",children:(0,x.jsx)("div",{className:"cvz-max-w-[85%] cvz-bg-white cvz-border cvz-border-gray-100 cvz-p-3 cvz-rounded-2xl cvz-rounded-bl-none cvz-text-sm cvz-shadow-sm cvz-text-gray-800",children:n})}),t&&!n&&(0,x.jsx)("div",{className:"cvz-flex cvz-justify-start",children:(0,x.jsx)("div",{className:"cvz-bg-white cvz-border cvz-border-gray-100 cvz-p-3 cvz-rounded-2xl cvz-rounded-bl-none cvz-shadow-sm",children:(0,x.jsxs)("div",{className:"cvz-flex cvz-space-x-1",children:[(0,x.jsx)("div",{className:"cvz-w-2 cvz-h-2 cvz-bg-gray-400 cvz-rounded-full cvz-animate-bounce",style:{animationDelay:"0ms"}}),(0,x.jsx)("div",{className:"cvz-w-2 cvz-h-2 cvz-bg-gray-400 cvz-rounded-full cvz-animate-bounce",style:{animationDelay:"150ms"}}),(0,x.jsx)("div",{className:"cvz-w-2 cvz-h-2 cvz-bg-gray-400 cvz-rounded-full cvz-animate-bounce",style:{animationDelay:"300ms"}})]})})}),(0,x.jsx)("div",{ref:r})]})},Yp=({value:e,onChange:t,onSubmit:n,isLoading:r,placeholder:o})=>(0,x.jsxs)("form",{onSubmit:n,className:"cvz-p-4 cvz-bg-white cvz-border-t cvz-border-gray-100",children:[(0,x.jsxs)("div",{className:"cvz-relative cvz-flex cvz-items-center",children:[(0,x.jsx)("input",{type:"text",value:e,onChange:l=>t(l.target.value),placeholder:o,className:"cvz-w-full cvz-bg-gray-50 cvz-border cvz-border-gray-200 cvz-text-gray-900 cvz-text-sm cvz-rounded-full cvz-pl-4 cvz-pr-12 cvz-py-3 cvz-focus:cvz-outline-none cvz-focus:cvz-border-blue-500 cvz-focus:cvz-ring-1 cvz-focus:cvz-ring-blue-500 cvz-transition-all"}),(0,x.jsx)("button",{type:"submit",disabled:!e.trim()||r,className:"cvz-absolute cvz-right-2 cvz-p-2 cvz-bg-blue-600 cvz-text-white cvz-rounded-full cvz-hover:cvz-bg-blue-700 cvz-disabled:cvz-opacity-50 cvz-disabled:cvz-hover:cvz-bg-blue-600 cvz-transition-colors cvz-shadow-sm",children:(0,x.jsx)(Hp,{})})]}),(0,x.jsx)("div",{className:"cvz-text-center cvz-mt-2",children:(0,x.jsx)("p",{className:"cvz-text-[10px] cvz-text-gray-400",children:"Powered by ConverZent"})})]}),Xp=({config:e})=>{let[t,n]=(0,J.useState)(!1),[r,o]=(0,J.useState)([]),[l,i]=(0,J.useState)(""),[u,s]=(0,J.useState)(!1),[c,p]=(0,J.useState)(!1),[m,v]=(0,J.useState)(""),[y,w]=(0,J.useState)(null),k=(0,J.useRef)(null),T=(0,J.useRef)(null),d=(0,J.useRef)(null);(0,J.useEffect)(()=>{(async()=>{try{let B=await e.onLoadMessages(),X=[];if(Array.isArray(B)&&B.length>0?X=B:e.initialGreeting&&(X=[{content:e.initialGreeting,role:"SYSTEM",createdAt:new Date().toISOString()}]),o(X),e.sessionId)w(e.sessionId),localStorage.setItem("cvz-widget-session-id",e.sessionId);else{let F=localStorage.getItem("cvz-widget-session-id");F&&w(F)}}catch(B){console.error("Failed to load messages:",B)}})()},[e]);let a=async(ie=!1)=>{if(e.apiKey)return{token:e.apiKey,type:"apiKey"};if(!e.getToken)throw new Error("Either apiKey or getToken must be provided");if(!ie){let X=Date.now(),F=d.current;if(F&&(F.expiresAt===null||F.expiresAt>X))return{token:F.token,type:"bearer"}}let B=await e.getToken();if(typeof B=="string")return d.current={token:B,expiresAt:null},{token:B,type:"bearer"};{let X=B.expiresAt||null;return d.current={token:B.token,expiresAt:X},{token:B.token,type:"bearer"}}},f=async(ie,B,X,F=0)=>{try{let xe=await a(F>0),uu=e.chatUrl||Up,rd=!y,Uo;rd?Uo=Kc({baseUrl:uu,message:ie.content,persona:e.persona,authToken:xe.token,authType:xe.type,abortSignal:X.signal}):Uo=Yc({baseUrl:uu,sessionId:y,message:ie.content,authToken:xe.token,authType:xe.type,abortSignal:X.signal});let dr="",Ao=!1;for await(let Qe of Uo){if(X.signal.aborted)break;switch(Qe.type){case"session_created":case"session_continued":Qe.session_id&&(w(Qe.session_id),localStorage.setItem("cvz-widget-session-id",Qe.session_id),console.log("Session ID:",Qe.session_id));break;case"token":Qe.content&&(dr+=Qe.content,v(dr));break;case"done":if(dr){let ld={content:dr,role:"ASSISTANT",createdAt:new Date().toISOString(),sources:Qe.sources},au=[...B,ld];o(au),await e.onSaveMessages(au)}v(""),p(!1),s(!1),T.current=null;return;case"error":let At=Qe.message||"";if((At.includes("401")||At.includes("403")||At.includes("Unauthorized")||At.includes("Forbidden"))&&F<1&&e.getToken&&!e.apiKey){console.log("Unauthorized error detected, refreshing token and retrying..."),d.current=null,Ao=!0;break}console.error("Stream error:",At);let od={content:`Error: ${At||"An error occurred"}`,role:"SYSTEM",createdAt:new Date().toISOString()},su=[...B,od];o(su),await e.onSaveMessages(su),v(""),p(!1),s(!1),T.current=null;return}}if(Ao&&F<1)return f(ie,B,X,F+1);!X.signal.aborted&&!Ao&&(console.error("Stream ended unexpectedly"),v(""),p(!1),s(!1),T.current=null)}catch(xe){if(xe instanceof Error&&(xe.message.includes("401")||xe.message.includes("403"))&&F<1&&e.getToken&&!e.apiKey)return console.log("Unauthorized error detected, refreshing token and retrying..."),d.current=null,f(ie,B,X,F+1);throw xe}},g=async ie=>{if(ie?.preventDefault(),!l.trim()||c)return;T.current&&T.current.abort();let B={content:l.trim(),role:"USER",createdAt:new Date().toISOString()},X=[...r,B];o(X),i(""),s(!0),p(!0),v("");try{let F=new AbortController;T.current=F,await f(B,X,F)}catch(F){if(console.error("Error sending message:",F),F instanceof Error&&F.name==="AbortError"){v(""),p(!1),s(!1),T.current=null;return}let Fo={content:`Error: ${F instanceof Error?F.message:"Failed to send message"}`,role:"SYSTEM",createdAt:new Date().toISOString()},xe=[...X,Fo];o(xe),await e.onSaveMessages(xe),v(""),p(!1),s(!1),T.current=null}},S=async()=>{window.confirm("Are you sure you want to clear your chat history?")&&(T.current&&(T.current.abort(),T.current=null),o([]),v(""),w(null),p(!1),s(!1),localStorage.removeItem("cvz-widget-session-id"),await e.onSaveMessages([]))},C=Ap(e.style),E=$p(e.style),_=Vp(e.style),W=Wp(e.style,t),N=!e.style?.position||typeof e.style.position=="string"&&(e.style.position==="bottom-right"||e.style.position==="bottom-left")||typeof e.style.position=="object"&&e.style.position.bottom,he=!e.style?.position||typeof e.style.position=="string"&&(e.style.position==="bottom-right"||e.style.position==="top-right")||typeof e.style.position=="object"&&e.style.position.right;return(0,x.jsxs)("div",{className:"cvz-fixed cvz-z-[9999] cvz-font-sans",style:C,children:[(0,x.jsxs)("div",{className:`
        ...
        `,style:{backgroundColor:W.backgroundColor},onMouseEnter:ie=>{!t&&e.style?.buttonColor?.hover&&(ie.currentTarget.style.backgroundColor=e.style.buttonColor.hover)},onMouseLeave:ie=>{t||(ie.currentTarget.style.backgroundColor=W.backgroundColor)},children:(0,x.jsx)("div",{className:"cvz-text-white",children:t?(0,x.jsx)(qc,{}):(0,x.jsx)(Jc,{})})})]})},bc=Xp;var iu=`*, ::before, ::after {
